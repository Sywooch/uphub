...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 14, 2016 at 09:39 AM
...
INSERT INTO `address` (`id`, `number`, `moo`, `district_id`, `rent_id`) VALUES
(1, NULL, NULL, 8914, NULL),
(2, NULL, NULL, 11, NULL),
(3, NULL, NULL, 13, NULL),
(4, NULL, NULL, 14, NULL),
(5, NULL, NULL, 15, NULL),
...
(11, NULL, NULL, 21, NULL),
(12, NULL, NULL, 22, NULL),
(13, NULL, NULL, NULL, NULL),
(14, NULL, NULL, NULL, NULL),
(15, NULL, NULL, 26, NULL),
(16, NULL, NULL, 27, NULL),
(17, NULL, NULL, NULL, NULL),
(18, NULL, NULL, NULL, 29),
(19, NULL, NULL, NULL, 30),
(20, NULL, NULL, NULL, 31),
(21, NULL, NULL, NULL, 32),
(22, NULL, NULL, NULL, 33),
(23, NULL, NULL, NULL, 34);
...
INSERT INTO `rent` (`id`, `name`, `near`, `intendant`, `cost_water`, `cost_elec`, `tel1`, `tel2`, `web`, `type_gen`, `type_rent`, `user_id`, `condition`, `edited`, `visible`, `address`) VALUES
(18, 'บ้านพักบุญทิวาอิอิ', 'ทางเข้าอ่างแม่ต๋ำ', 'คุณวอน', 50, 7, '084-9173664', '', '-', '2', '1', 1, '', NULL, 1, '501/1'),
(19, 'บ้านพักภัคนารีโฮม', 'ซอยจอดรถจักรยานยนต์', 'คุณเยาว์  แก้วสาย', NULL, NULL, '', '', '', 'prompt', 'prompt', 1, '', '2016-02-11 17:00:00', 1, NULL),
(23, 'test', 'test', 'test', 50, 100, '000', '000', 'test', '0', '0', 1, 'test', '2016-02-11 17:00:00', 1, NULL),
(24, 'test', 'test', 'test', 50, 100, '000', '000', 'test', '0', '0', 1, 'test', '2016-02-11 17:00:00', 1, NULL),
(25, 'test', 'test', 'test', 50, 100, '089-8522599', '0981234657', 'yyyy.hhh', '1', '0', 1, 'test', '2016-02-16 17:00:00', 1, NULL),
(26, 'test', 'test', 'test', 50, 100, '546', '', 'หกเ', '1', '0', 1, 'test', '2016-02-11 17:00:00', 1, NULL),
(27, 'หอราชพฤกษ์', 'ศาลาเหลือง', 'test', 50, 100, '089-8522599', '0981234657', 'หกเ', '1', '1', 1, '465', '2016-02-11 17:00:00', 1, NULL),
(28, 'บ้านบ้าน', 'ซอยศาลาเหลือง เซเว่นใหม่', 'ีีhappy', 58, 88, '0981234657', '0981234657', 'yyyy.hhh', '1', '0', 1, '456', '2016-02-11 17:00:00', 1, NULL),
(29, 'japan', 'ซอยศาลาเหลือง เซเว่นใหม่', 'นาง จิตตวีร์ กีรติศักดิ์วรกุล', 50, 40, '0981234657', '0981234657', 'yyyy.hhh', '1', '0', 1, 'asdf', '2016-02-11 17:00:00', 1, NULL),
(30, 'ีีีuuu', 'ีีีuuu', 'ีีีuuu', 50, 100, '0981234657', '0981234657', 'yyyy.hhh', '0', '1', 1, 'uuu', NULL, 1, NULL),
(31, 'yyy', 'yyy', 'yyy', 50, 100, '089-8522599', '0981234657', 'yyyy.hhh', '0', '1', 1, 'yyy', '2016-02-12 19:57:22', 1, NULL),
(32, '11', '11', '1', 11, 11, '11', '11', '11', '0', '0', 1, '11', '2016-02-12 19:57:17', 1, NULL),
(33, 'ทดสอบ', 'ทดสอบ', 'ทดสอบ', 50, 100, '0981234657', '0981234657', 'ทดสอบ', '0', '0', 1, 'ทดสอบ', '2016-02-12 17:00:00', 1, 'ทดสอบ'),
(34, 'testtest', 'testtest', 'testtest', 50, 100, '0981234657', '', 'yyyy.hhh', '1', '0', 1, 'testtest', '2016-02-12 17:00:00', 1, 'testtest');
...
CREATE TABLE `room` (
  `id` int(11) NOT NULL,
  `floor` int(11) DEFAULT NULL COMMENT 'ชั้น',
  `number` int(11) DEFAULT NULL COMMENT 'เลขห้อง',
  ...
  `start_date` datetime DEFAULT NULL COMMENT 'วันที่ทำการจอง',
  `end_date` datetime DEFAULT NULL COMMENT 'วันหมดอายุการจอง',
  `rent_id` int(11) NOT NULL COMMENT 'หอพัก',
...
INSERT INTO `uploads` (`upload_id`, `file_name`, `real_filename`, `create_date`, `type`, `albumn_id`, `rent_id`) VALUES
(3, 'DSCF9951.jpg', '4e4dabd86a769417440053c6b33b9470.jpg', '2016-02-11 20:14:01', NULL, 0, 18),
(4, 'DSCF9973.jpg', '1e737bb9f9cd6b252c9631bb0bc150c2.jpg', '2016-02-11 20:14:01', NULL, 0, 18),
(6, 'DSCF9977.jpg', 'bb93818d74fb5f8358c1bdff48d3c125.jpg', '2016-02-11 20:14:02', NULL, 0, 18),
(8, '3.jpg', 'b916bd4083e6af6670fd86215d1fbfd0.jpg', '2016-02-11 20:32:39', NULL, 0, 19),
(9, 'DSCF9982.jpg', 'fa50098b8874f8f20284ff684d770241.jpg', '2016-02-11 21:38:42', NULL, 0, 27),
(10, 'DSCF9984.jpg', 'f5a63b40dcc7e341d1fb2456837bc010.jpg', '2016-02-11 21:43:02', NULL, 0, 28),
(11, 'DSCF9988.jpg', '475c941852441d5e801a4d7425f96917.jpg', '2016-02-11 21:52:55', NULL, 0, 29);
...
INSERT INTO `user` (`id`, `username`, `email`, `password_hash`, `password_reset_token`, `auth_key`, `created_at`, `updated_at`, `role_id`, `id_fb`, `status`) VALUES
...
--
-- AUTO_INCREMENT for table `accessories_has_room`
--
ALTER TABLE `accessories_has_room`
...
--
ALTER TABLE `address`
  ADD CONSTRAINT `FK_district_id` FOREIGN KEY (`district_id`) REFERENCES `district` (`id`),
  ADD CONSTRAINT `FK_rent_id` FOREIGN KEY (`rent_id`) REFERENCES `rent` (`id`);
