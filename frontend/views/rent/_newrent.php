...
?><div class="row">
		...
		<div class="col-md-10 col-md-offset-1" >
			...
			<div class="callbacks_container">
					...
					<?php if ($backVisible==1) {
						?>
						<button id="back" type="button" class="btn btn-default" aria-label="Left Align" onclick="back()" style="position: absolute;top: 225px;height: 10%;left: -50px;" >
						  <span class="glyphicon glyphicon-triangle-left" aria-hidden="true"></span>
						</button>
						<?php }?>
					
<?php if ($allPage!=$frontVisible) {
	?>
					<button id="next" type="button" class="btn btn-default" aria-label="Left Align" onclick="next()" style="position: absolute;top: 225px;right: -35px;height: 10%;">
