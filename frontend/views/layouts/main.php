...
<div id="overlay-1">
    ...
    NavBar::begin([
        ...
        'brandOptions' => ['class' => 'img-responsive hidden-xs'],
...
<div class="footer" style="color: white">
			...
			<div class="row" align="center">
				<h3>ติ ด ต่ อ</h3>
  				<a href="https://www.facebook.com/UPHUB-523512031190520/" ><?php echo Html::img('@web/img/facebook.png')?></a>
  				<a href="#" ><?php echo Html::img('@web/img/gmail.png')?></a>
  				<a href="#" ><?php echo Html::img('@web/img/twiter.png')?></a><br>
  				 เบอร์โทรติดต่อ : 087-4453719,085-1688917<br>
  				E-mail : uphub.u@gmail.com
  				<p class="text-muted"><h6>Copyright ©2016 Software Engineering UP</h6></p>
			</div>
